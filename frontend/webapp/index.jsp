...
<head>
    ...
    <script>
        var ctx = "${pageContext.request.contextPath}";  // 动态获取上下文路径
    </script>
    ...
    <style type="text/css">
        ...
        #promotion {
            ...
            left: 25%;
            top: 27%;
            background: url(${pageContext.request.contextPath}/image/back_12-28.jpg);
            font-family: KaiTi;
            font-size: 450%;
...
<body>
<img src="${pageContext.request.contextPath}/image/12-28.jpg" id="bg_img">


<a href="${pageContext.request.contextPath}/learnmore" id="promotion" style="margin-left: -15px;">
    <img src="${pageContext.request.contextPath}/image/OIP-C.png" alt="医院公告图" style="height: 100px; width: auto; margin-right: 15px;" />
    点击查看医院公告
</a>
...
<div class="login-main">
    ...
    <form class="layui-form" lay-filter="login">
        ...
        <div class="layui-btn layui-btn-radius" style="margin-left: 5px">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/pubilc.js"></script>
</body>
</html>
